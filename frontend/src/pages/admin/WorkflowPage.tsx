    ...
    return (
        <div className="space-y-6 pb-20 animate-in fade-in duration-300">
            <div className="flex flex-col md:flex-row gap-4 justify-between md:items-center w-full bg-white p-3 sm:p-4 rounded-2xl border border-slate-100 shadow-sm">
                <div>
                    <h2 className="text-lg font-bold text-slate-800">Цепочка согласования</h2>
                    <p className="text-slate-500 font-medium text-[13px] mt-0.5">Настройка этапов утверждения заявок на изменение зарплаты</p>
                </div>
                <div className="flex items-center gap-3 w-full md:w-auto justify-end">
                    <button
                        onClick={() => setIsHelpOpen(true)}
                        className="flex items-center gap-2 text-slate-400 hover:text-slate-600 transition-colors text-sm font-bold shrink-0"
                    >
                    ...
                    <button
                        ...
                        className="bg-slate-900 text-white px-4 py-2 rounded-xl text-sm font-bold flex items-center justify-center gap-2 hover:bg-slate-800 transition-all shadow-lg shadow-slate-900/10 shrink-0"
                    >
                        + Добавить этап
                    </button>
                </div>
